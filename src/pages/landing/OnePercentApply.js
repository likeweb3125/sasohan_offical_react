...
const OnePercentApply = () => {
    ...
    const termsList = [
        { value: 1, txt: "개인정보 보호정책 동의" },
        { value: 3, txt: "개인정보 수집 및 이용동의" },
        { value: 4, txt: "이용약관 동의" },
        { value: 6, txt: "광고성 메시지 수신 동의" },
    ];
    ...
    const scrollSectOn = () => {
        ...
        const sections = [{ ref: sect3Ref, onSet: setSect3On }];
    ...
    const handleRemove = (idx, url) => {
        ...
        axios
            .delete(vip_apply_img_delt.replace(":filename", filename))
            .then((res) => {
                if (res.status === 200) {
                    let newList = [...imgList];
    ...
    const profileImgs = imgList.map((img, i) => (
        <li key={i} className="flex flex_top">
            ...
            <button
                type="button"
                className="btn_delt"
                onClick={() => handleRemove(i, img.url)}
            >
                삭제
            </button>
        </li>
            ...
            <div className="one_apply">
                <div className="main_banner">
                    ...
                    <div className="txt_box">
                        ...
                        />
                        <img
                            src={main_banner_txt_tab}
                            alt="1% 폴라로이드를 찍어봐"
                            className="img_tab"
                        />
                        <img
                            src={main_banner_txt_mo}
                            alt="1% 폴라로이드를 찍어봐"
                            className="img_mo"
                        />
                    </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <div>
                                ...
                                <p>
                                    상위 1% 외모의 지인을 추천해 주세요! <br />
                                    지인과 함께 추천비 혜택을 누릴 수 있습니다.
                                </p>
                            </div>
                ...
                <div className={`sect3${sect3On ? " on" : ""}`} ref={sect3Ref}>
                    <div className="inner">
                        <img
                            src={sect3_heart1}
                            alt="하트이미지"
                            className="heart_img heart_img1"
                        />
                        <img
                            src={sect3_heart2}
                            alt="하트이미지"
                            className="heart_img heart_img2"
                        />
                        <img
                            src={sect3_heart3}
                            alt="하트이미지"
                            className="heart_img heart_img3"
                        />
                        <img
                            src={sect3_heart4}
                            alt="하트이미지"
                            className="heart_img heart_img4"
                        />
                        <div className="img_box">
                        ...
                        <div className="form_box">
                            ...
                            <ul className="txt_ul">
                                <li>
                                    상위 1% 선정 시, 첫 이용 특전 20만 원이
                                    지급됩니다.
                                </li>
                                <li>
                                    상위 1% 선정 시, 담당자가 검토 후 제공해주신
                                    연락처로 개별 연락드릴 예정입니다.
                                </li>
                                <li>
                                    상위 1% 미선정 시, 이상형의 프로필을 무제한
                                    열람할 수 있도록 연락드릴 예정입니다.
                                </li>
                            </ul>
                            <Formik
                                initialValues={{
