...
const authImgs = [sect4_auth1, sect4_auth2, sect4_auth3, sect4_auth4];
...
const SelectMember = () => {
    ...
    const getAddress2 = (code) => {
        axios
            .get(`${m_address2.replace(":parent_local_code", code)}`)
            .then((res) => {
                if (res.status === 200) {
    ...
    return (
        <>
                ...
                <div className="select_apply_wrap">
                    <div className="inner" id="main">
                        <div className="cont_box">
                            ...
                            <div
                                className={`sect sect1${sect1On ? " on" : ""}`}
                                ref={sect1Ref}
                            >
                                <ul className="txt_box">
                                    ...
                                    <li>
                                        ...
                                        <p>
                                            나의 외모? 집? 차? 연봉? NO NO NO!{" "}
                                            <br />
                                            아무 조건 없이! <br />
                                            내가 택한 외모 상위 1% 상대와의 연결
                                        </p>
                                    </li>
                                </ul>
                            ...
                            <div
                                className={`sect sect2${sect2On ? " on" : ""}`}
                                ref={sect2Ref}
                            >
                                <div className="txt_box">
                                    ...
                                    <h5>
                                        아래 인물들은
                                        <strong>사소한의 공식모델</strong>
                                        입니다.
                                    </h5>
                                    <p>
                                        해당 모델은 1% 회원들의 외모 수준과
                                        동일합니다.
                                    </p>
                                    <h6>
                                        오직! <span>선택 회원</span>{" "}
                                ...
                                <div className="slider">
                                    <ul className="img_ul flex">
                                        {memberList.map((_, i) => (
                                            <li
                                                key={i}
                                                className={
                                                    memberSliderActive === i
                                                        ? "on"
                                                        : ""
                                                }
                                                onClick={() => {
                                                    if (
                                                        memberSwiperRef.current &&
                                                        memberSwiperRef.current
                                                            .swiper
                                                    ) {
                                                        memberSwiperRef.current.swiper.slideToLoop(
                                                            i
                                                        );
                                                    }
                                                }}
                                    ...
                                    <Swiper
                                        ...
                                        navigation={{
                                            nextEl: ".sect2 .slider .swiper-button-next",
                                            prevEl: ".sect2 .slider .swiper-button-prev",
                                        }}
                                        onSlideChange={(e) => {
                            ...
                            <div
                                className={`sect sect3${sect3On ? " on" : ""}`}
                                ref={sect3Ref}
                            >
                                <div className="box">
                            ...
                            <div
                                className={`sect sect4${sect4On ? " on" : ""}`}
                                id="sect4"
                                ref={sect4Ref}
                            >
                                <div className="txt_box">
                                    <h4 className="top_tit">
                                        <strong>믿을 수 있는 </strong>
                                        <span>사소한 시스템</span>
                                    </h4>
                                    <h6>
                                        서비스 사소한 1%는{" "}
                                        <strong>위법 행위 근절</strong>에 힘쓰고
                                        있습니다.
                                    </h6>
                                    <p>
                                        또한, 회원님들의 안전한 개인정보 보호를
                                        위한 개인정보 교육을 수료하였으며,{" "}
                                        <br />
                                        자발적인 비용을 지불하여 법률자문을
                                        받음으로써 <br />
                                ...
                                <div className="slider">
                                    <Swiper
                                        ...
                                        effect="fade"
                                        navigation={{
                                            nextEl: ".sect4 .btn_box .swiper-button-next",
                                            prevEl: ".sect4 .btn_box .swiper-button-prev",
                                        }}
                                        pagination={{
                                            type: "fraction",
                            ...
                            <div
                                className={`sect sect5${sect5On ? " on" : ""}`}
                                id="sect5"
                                ref={sect5Ref}
                            >
                                {reviewList.length > 0 && (
                                                                ...
                                                                <div className="input_box5">
                                                                    <select
                                                                        ...
                                                                        onChange={(
                                                                            ...
                                                                            if (
                                                                                address1_txt.includes(
                                                                                    "광역시"
                                                                                )
                                                                            ) {
                                                                                address1_txt =
                                                                                    address1_txt.replace(
                                                                                        "광역시",
                                                                                        ""
                                                                                    );
                                                                            }
                                                ...
                                                <div className="agree_box">
                                                    {termsList.map(
                                                        (cont, i) => (
                                                            <div
                                                                key={`terms_${i}`}
                                                                className="custom_check3"
                                                            >
                                                                <label
                                                                    htmlFor={`terms${cont.value}`}
                                                                >
                                                                    <input
                                                                        type={`checkbox`}
                                                                        onChange={(
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    window.gtag_report_conversion(
                                                        "https://sasohan.net/apply/1percent/17"
                                                    );
                                                }}
                                            >
                                                신청서 제출
                ...
                <div className="footer">
                    ...
                    <div className="bottom_box">
                        <div className="inner">
                            ...
                            <div className="copy">
                                COPYRIGHT© 2023 사소한 ALL RIGHTS RESERVED.
                            </div>
                        </div>
                        <div className="sns_box">
                            ...
                            <ul className="flex">
                                ...
                                <li>
                                    <a
                                        href="https://www.facebook.com/people/%EC%82%AC%EC%86%8C%ED%95%9C-1/61565280974906/"
                                        target={"_blank"}
                                    >
                                        페이스북
                                    </a>
                                ...
                                <li>
                                    <a
                                        href="https://www.tiktok.com/@sasohan_1"
                                        target={"_blank"}
                                    >
                                        틱톡
                                    </a>
            ...
            {submitConfirm && (
                <ConfirmPop
                    closePop="custom"
                    onCloseHandler={() => window.location.reload()}
                />
            )}
        </>
    );
