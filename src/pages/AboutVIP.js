                ...
                <div className="cont4">
                    <div className="txt_box">
                        ...
                        <p className="txt2">두 유형의 회원님들은 매니저의 매칭을 통해 서로 소개팅을 주선받습니다. <br/><br/>
                            ...
                            반면, 1% 회원은 자신의 매력을 인정받아 소개팅 시 픽켓을 전달받는 혜택을 누리게 됩니다.</p>
                    </div>
                ...
                <div className="cont4">
                    ...
                    <div className="txt_box">
                        ...
                        <p className="txt3">단순하지만 비용을 지불하는 소개팅에 있어 본질적으로 최고의 장점입니다.<br/>
                            ...
                            사소한은 지난 12년의 노하우로 그것을 가능케 하는 능력이 있습니다.</p>
                        ...
                        <div className="txt_box">
                            ...
                            <ul className="txt_ul">
                                <li className={aboutTab === 0 ? "on" : ""}>
                                    ...
                                    <p className="txt2">이 과정에서, 사소한1%는 소개팅을 유료로 진행한 결제자님에게 소개팅 비용 88,000원과<br/>
                                    픽켓비용 22,000원을 받아 픽켓 22,000원을 1%회원님에게 전달하게 됩니다.<br/>
                                    이 2만2천원을 <span>픽켓</span>이라고 부르며, 픽켓은 <span>PICK(선택하다) + TICKET(입장권) 의 합성어</span> 입니다. <br/><br/>

                                    픽(PICK)은 유료 결제자님이 원하는 상대를 선택하고 의사를 전달해 소개팅이 시작될 수 있도록 도우며,<br/>
                                    티켓은 소개팅에 참여할 수 있는 입장권으로, <br/>
                                    선택 회원님께서 <span>입장권을 소지함으로써 소개팅에 참여할 자격</span>이 부여됩니다. <br/><br/>

                                    픽켓은 소개팅을 열기 위해 필수적으로 필요한 티켓이며, 소개팅 오픈 시 자동적으로 소진되는 티켓입니다. <br/><br/>

                                    더불어, 소개팅 파트너에게 책임감을 부여하여 유연하고 진지한 태도로 소개팅에 참여할 수 있도록 유도합니다. <br/><br/>

                                    사소한 1% 소개팅은 픽켓을 활용하여 유료 결제자님에게 <span>확실한 이상형 선택의 기회를 제공</span>합니다. <br/>
                                    픽켓 시스템은 사소한 만이 진행하는 독창적인 시스템입니다. <br/><br/>

                                    비록 소개팅 비용에 있어서는 유료결제와, 픽켓 사이의 비평등함이 존재하지만, <br/>
                                    오히려 놀랍게도 이를 통해 더 많은 이상형을 <br/>
                                    <span>매칭 받을 수 있는 기회의 평등함이 제공됩니다. </span><br/><br/>

                                    따라서 픽켓 시스템을 이용한 소개팅은 소개팅 경험에 대한 <br/>
                        ...
                        <div className="box tx_c">
                            ...
                            <ul className="img_ul flex_between flex_wrap">
                                ...
                                <li>
                                    ...
                                    <p>만남 성공을 위한 종합 서포터 <br/>챠밍매니저 케어</p>
                                </li>
                            </ul>
                            <div className="btn_box">
                ...
                <div className="cont4">
                        ...
                        <div className="box tx_c">
                            ...
                            <ul className="img_ul flex_between flex_wrap">
                                <li>
                                    ...
                                    <p>소개팅 진행 시 선택 회원님께서 <br/>2만 2천원의 픽켓 전달</p>
                                </li>
                                <li>
                    ...
                    <div className="gray_box">
                        ...
                        <ul className="txt_ul flex_wrap">
                            ...
                            <li><strong>6. </strong>그 외 "픽켓" 이외의 금액을 편취한 경우</li>
                        </ul>
                    </div>
                </div>
            </div>
